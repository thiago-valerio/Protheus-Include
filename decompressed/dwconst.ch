...
// Modulo : Ferramentas
// Fonte  : DWConst - Constantes de uso genrico
// ---------+-------------------+--------------------------------------------------------
// Data     | Autor             | Descricao
// ---------+-------------------+--------------------------------------------------------
// 25.06.01 | 0548-Alan Candido |
// 23.11.07 | 0548-Alan Candido | BOPS 136453 - Definio da constante EX_REN_TABLE
// 18.01.08 | 0548-Alan Candido | BOPS 139342 - Implementao e adequao de cdigo, 
//          |                   | em funo de re-estruturao para compartilhamento de 
//          |                   | cdigo.
// 18.03.08 | 0548-Alan Candido | BOPS 142638 - Implementao das constantes MAGIC_*,
//          |                   | para auxiliar na montagem de DD
// 29.05.08 | 0548-Alan Candido | BOPS 146059
//          |                   | Implementao de novos identificadores para acesso a
//          |                   | propriedades da consulta
// 25.11.08 | 0548-Alan Candido | FNC 00000007374/2008 (10) e 00000007385/2008 (8.11)
//          |                   | . Implementao de novos identificadores para acesso a
//          |                   | propriedades da consulta
//          |                   | . Definio da constante SEL_BUILD
// 15.12.08 | 0548-Alan Candido | FNC 09025/2008 (8.11) e 09034/2008 (10)
//          |                   | Adequao de gerao de mscara em campos numricos e datas, 
//          |                   | para respeitar o formato conforme idioma 
//          |                   | (chave RegionalLanguage na sesso do ambiente).
// --------------------------------------------------------------------------------------

/*
-----------------------------------------------------------------------------------------
Constantes de uso para execuo de consultas
-----------------------------------------------------------------------------------------
*/        
...
#define VAZIO        			  "{VAZIO}"
// Inclui o arquivo de traduo do prprio
#INCLUDE "dwtconst.ch"
...
O nome das tabelas seguem o formato
	DWFFSSV, onde
		...
		FF - familia das tabelas, varia de 01 at at ZZ
		SS - sequencia das tabelas na famlia, , varia de 00 at at ZZ, 
			  onde tabela 00  a pai e as demais sero filhas (Master/Detail)
		V  - sequencia da viso ou alias de select especfico, varia de 0 at Z,
			  onde 0  a tabela fixa	  
-----------------------------------------------------------------------------------------
*/                     
...
#define GI_HTML   1    // Tipo 1, com informaes para "get" em html
#define GI_GET    2    // Tipo 2, com informaes para "get" em adv/pl
#define GI_USER   3    // Tipo 3, com informaes para "get" definidas pelo usurio

/*
-----------------------------------------------------------------------------------------
Identificador os tipos de agregaes disponiveis
-----------------------------------------------------------------------------------------
*/
#define AGG_NONE         -1
#define AGG_SUM           0
...
/*
-----------------------------------------------------------------------------------------
Identificador dos tipos de grficos a serem utilizados
-----------------------------------------------------------------------------------------
*/
#define CHART_BAR       0
...
/*
-----------------------------------------------------------------------------------------
Identificador de atributos para dimenso temporal
-----------------------------------------------------------------------------------------
*/
#define DT_DT				   0
#define DT_ANO				   1
...
#define DT_TITLES ({ "DT", _TRAD0005, _TRAD0006, _TRAD0007, _TRAD0008, _TRAD0009, _TRAD0010, _TRAD0011, _TRAD0012, _TRAD0013, _TRAD0014, _TRAD0015, _TRAD0016, _TRAD0017, _TRAD0031, "Ano/Ms" })/*//"Ano"###"Periodo"###"Estao"###"Semestre"###"Quadrimestre"###"Trimestre"###"Bimestre"###"Ms"###"Quinzena"###"Semana"###"Dia"###"Dia sem."###"Dia greg."*///####TRADUZIR
...
/*
-----------------------------------------------------------------------------------------
Tipos de arquivo para a importao
-----------------------------------------------------------------------------------------
*/
...
#define EST_TITLES { _TRAD0018 + '<i>[@D]</i>' + _TRAD0019 + '<i>[XXXXXXXX]</i>' /*//'Dados extrados em '###' s '*/, ;
							_TRAD0020 + '<i>[999,999,999]</i>' + _TRAD0021 + '<i>[999,999,999]</i>'/*//'Foram extrados '###' registro(s) de um universo de '*/, ;
							_TRAD0022 + '<i>[@X]</i>'/*//'Tempo de construo '*/, ;
							_TRAD0023 + '<i>[@X]</i>'/*//'Tempo de sumarizao '*/, ;
							_TRAD0024 + '<i>[@D]</i>' + _TRAD0019 + '<i>[XXXXXXXX]</i>'/*//'O ltimo acesso foi em '###' s '*/, ;
							_TRAD0025 + '<i>download</i>' + _TRAD0026 + '<i>[@x]</i>'/*//'O tempo mdio de '###'  '*/,;
							_TRAD0027 + '<i>[999,999]</i>' + _TRAD0028/*//'Foi visualizada '###' vezes'*/, ;
							_TRAD0029 + '<i>[99,999.99]</i> (kbytes)'/*//'O tamanho mdio das pginas  de '*/,;
							_TRAD0030 + '<i>[@X]</i>'/*//'Campos virtuais/filtros '*/ }

/*
-----------------------------------------------------------------------------------------
ID para acesso ao array de definio de campos
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
ID para acesso ao array de espao em uso (tam. fisico da tabelas)
-----------------------------------------------------------------------------------------
*/
#define SPC_ROWS            1
#define SPC_SIZE            2
...
/*
-----------------------------------------------------------------------------------------
Tipos de conexo para acessar arquivos/dados
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Identificadore de verso do TopConnect
-----------------------------------------------------------------------------------------
*/
...
-----------------------------------------------------------------------------------------
*/
#define AG_IMP		0	// Agendamento de Fonte de Dados (Importao)
#define AG_DSN		1	// Agendamento de Fonte de Dados (Importao)
#define AG_EXP		2	// Agendamento de Exportao

/*
-----------------------------------------------------------------------------------------
Identificadores de tipos de exportaes
-----------------------------------------------------------------------------------------
*/
#define EX_CON		1	// Exportao de consulta
#define EX_DIM		2	// Exportao de dimenso
#define EX_CUBE	    3   // Exportao de cubos
#define EX_GRAF	    4	// Exportao de consulta - grafico

/*
-----------------------------------------------------------------------------------------
Comportamento a adotar quando existirem registros invlidos na importao do fato
-----------------------------------------------------------------------------------------
*/
...
-----------------------------------------------------------------------------------------
*/
#define UPDMET_DEFAULT          "1" // Mtodo default
#define UPDMET_INSERT           "2" // Insere com chaves duplicadas
#define UPDMET_UPDATE           "3" // Atualiza o registro j existente

/*
-----------------------------------------------------------------------------------------
Comportamento a adotar na gerao de listagem de invlidos
-----------------------------------------------------------------------------------------
*/
#define RPTINVAL_NONE           "1" // No gerar
...
/*
-----------------------------------------------------------------------------------------
Identificador de tipos de informao (typeInfo) para a TAB_DD
-----------------------------------------------------------------------------------------
*/
#define DD_INDEX			"I"
...
-----------------------------------------------------------------------------------------
*/
#define ST_DIMENSIONS_COUNT      "01000" // Numero de dimenses/registros por dimenso
#define ST_DIMENSIONS_ATT_COUNT  "01100" // Numero de atributos por dimenso
#define ST_DIMENSIONS_DS_COUNT   "01200" // Numero de fonte de dados por dimenso
#define ST_USERS_COUNT           "02000" // Numero de usurios
...
#define ST_CONNECTIONS_COUNT     "06000" // Numero de conexes
#define ST_CONNECTIONS_TOP_COUNT "06100" // Numero de conexes via TC
#define ST_CONNECTIONS_SX_COUNT  "06200" // Numero de conexes via SX
#define ST_CONNECTIONS_DIR_COUNT "06300" // Numero de conexes diretas
...
#define ST_BUILD_QUERYS          "12000" // Tempo de construo de consultas
#define ST_EXPORT_QUERYS         "12100" // Tempo de exportao de consultas

/*
-----------------------------------------------------------------------------------------
Opes para apresentao dos forms de filtros ou seleao na visualizao da cosulta
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Opes para aplicao automtica de filtros QBE nos Browsers.
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Identificadores de bits para liberao de acesso
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Valores de descrio do tipo de objetos
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Identificao do tipo de informao (grupo), passada via IPC
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Identificao de tipos de consultas
-----------------------------------------------------------------------------------------
*/
#define QUERY_USER			"U"//surio
#define QUERY_PREDEF		"P"//re-definida

/*
-----------------------------------------------------------------------------------------
Identificao das posies de informaes sobre a tela do browse
-----------------------------------------------------------------------------------------
*/
...
-----------------------------------------------------------------------------------------
*/
#define FIRST_PAGE        "PI"  // PI = Pgina Inicial
#define PREVS_PAGE        "PA"  // PA = Pgina Anterior
#define PREVS_RECORD      "PR"  // PR = reg. anterior
#define SELCT_PAGE        "SP"  // SP = Seleo de Pgina	
#define NEXT_RECORD       "NR"  // NR = prox. reg.
#define NEXT_PAGE         "PP"  // PP = Prxima Pgina
#define LAST_PAGE         "UP"  // UP = ltima Pgina
...
#define FIELD_INICIALIZER "INIT"     // Inicializa os campos para a tabela especfica
#define FIELD_TYPE        "TYPE"     // Pesquisar o tipo um campo
#define FIELD_SIZE        "SIZE"     // Pesquisar o tamanho um campo
#define FIELD_DEC_SIZE 	  "DECSIZE"  // Pesquisar o nmero de casas decimais de um campo
...
pelos mtodos de cache da classe TConsulta e nos arquivos que modifiquem ou acessem
uma consulta em cahe.
-----------------------------------------------------------------------------------------
*/
#define MEMO_CONS_QTDE_ELEMS   35 // Quantidade de elementos do array
#define MEMO_CONS_AXIS_X        1 // definio do eixo X
#define MEMO_CONS_AXIS_Y        2 // definio do eixo Y
#define MEMO_CONS_AXIS_M        3 // definio do eixo m (indicadores
#define MEMO_CONS_ALERT         4 // definio dos alertas
#define MEMO_CONS_WHERE         5 // definio dos filtros
#define MEMO_CONS_DRILL         6 // definio do drill
#define MEMO_CONS_RANK          7 // definio do rank
#define MEMO_CONS_RECLIM        8 // definio da propriedade de limite de registros
#define MEMO_CONS_INDSOBR       9 // definio da propriedade ind. sobre possto
#define MEMO_CONS_EMPTYCELL    10 // definio da propriedade empty cell
#define MEMO_CONS_FILTERED     11 // definio da propriedade filtered
#define MEMO_CONS_TOTAL        12 // definio da propriedade total
#define MEMO_CONS_ALERTON      13 // definio da propriedade alert on
#define MEMO_CONS_HINTON       14 // definio da propriedade hint on
#define MEMO_CONS_IGNZERO      15 // definio da propriedade ignorar zeros
#define MEMO_CONS_USEEXCEL     16 // definio da propriedade excel
#define MEMO_CONS_RANKON       17 // definio da propriedade rank on
#define MEMO_CONS_RNKOTHER     18 // definio da propriedade rankear outros
#define MEMO_CONS_ZERACUM      19 // definio da propriedade zera acumulados
#define MEMO_CONS_ISVALID      20 // definio da propriedade se consulta  valida
#define MEMO_CONS_GRAPHCLASS   21 // definio da propriedade classe do grfico
#define MEMO_CONS_GRAPHPROPS   22 // definio da propriedade do grfico
#define MEMO_CONS_GRAPHPY      23 // definio da propriedade Y do grfico
#define MEMO_CONS_GRAPHPY2     24 // definio da propriedade Y2 do grfico
#define MEMO_CONS_KEY_VALUES   25 // chaves de valores para a pginao
#define MEMO_CONS_AUTO_FILTER  26 // chaves de valores para o auto filter/seleo
#define MEMO_CONS_CUBE_ID      27 // ID do cubo da consulta
#define MEMO_CONS_PROPS        28 // Outras propriedades
#define MEMO_CONS_HIDEATT      29 // atributos no visiveis
#define MEMO_CONS_PAGE_KEYS	   30 // chaves usadas na paginao
#define MEMO_CONS_DRILL_HIST   31 // chaves usadas na paginao
#define MEMO_CONS_CURVAABC     32 // parametros para classificao da curva ABC
...
/*
-----------------------------------------------------------------------------------------
Identificadores dos mtodos utilizados para sumarizao no Oracle
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Identificadores dos mtodos utilizados para importao
-----------------------------------------------------------------------------------------
*/
...
/*
-----------------------------------------------------------------------------------------
Identificadores de dimenso e atributos reservados
-----------------------------------------------------------------------------------------
*/
...
#define RNK_STY_PADRAO    "x" // processamento padro
#define RNK_STY_CURVA_ABC "A" // curva abc
#define RNK_STY_LEVEL     "L" // por nvel de DD
#define RNK_STY_CLEAR     "C" // limpar definio


/*
-----------------------------------------------------------------------------------------
Identificadores das posies das informaes de classificao para a curva ABC
-----------------------------------------------------------------------------------------
*/
#define ABC_SIZE       5
#define ABC_CLASSIF    1  // classificao
#define ABC_PERC       2  // percentual
#define ABC_DESC       3  // descrio
#define ABC_COR        4  // cor de destaque
#define ABC_LIMITE     5  // limite inferior da classificao
...
/*
-----------------------------------------------------------------------------------------
MAGIC DEFINES - estes defines so utilzados na consulta, para definir que o atributo no
 vazio, mas deve ser apresentado como "branco"
-----------------------------------------------------------------------------------------
*/
#define MAGIC_CHAR     "{ #$}"          
