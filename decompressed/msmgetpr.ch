...
#define ENCH_COL1GET        (45)   /* coordenada X do get da primeira coluna 42 */
#define ENCH_COL2SAY        (157)  /* coordenada X do say da segunda coluna  157 */
#define ENCH_COL2GET        (200)  /* coordenada X do get da segunda coluna  197 */

// Ateno: o valor abaixo tem que corresponder a:
