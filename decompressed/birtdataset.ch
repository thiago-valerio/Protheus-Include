/*/{Protheus.doc} birtdataset.ch
	Definio da metalinguagem para definio de datasets para o BIRT.
	Inclui tambm definies de constantes de uso geral.
@author Renan Fragoso
@since 16/05/2014
@version 1.0
@description
	Contem os comandos da metalinguagem para definio de dataset para o BIRT.
