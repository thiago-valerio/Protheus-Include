/*/{Protheus.doc} tdsBirt.ch
	Definio da metalingguagem para definio de relatrios pr-definidos.
	Inclui tambm definies de constantes de uso geral.
@author acandido
@since 21/06/2013
@version 1.0
@description
	Contem os comandos da metalinguagem para definio de relatrios pr-definidos.
	Atravs destes comandos, o desenvolver definir o que ser obtido de dados e como,
	definindo as regras de seleo e agrupamento de dados, que sero utilizados em
	relatrios criados via Birt. O usurio deste relatrio, poder apenas trabalhar
	no leiuate dele.
...
//indexadores de apoio para acesso a definies efetuadas em arrays
#define IX_ALIAS 1
#define IX_TYPE  2
#define IX_LEN   3
#define IX_NDEC  4
...
#define E001_INVALID_PARAMS_TEXT "O usurio e/ou a senha informado so invlidas"

#define E002_REPORT_DEF_NOT_FOUND "E002_REPORT_DEF_NOT_FOUND"
#define E002_REPORT_DEF_NOT_FOUND_TEXT "A definio do relatrio solicitado no foi localizada."

#define E003_REPORT_TOO_MANY_DEF "E003_REPORT_TOO_MANY_DEF"
#define E003_REPORT_TOO_MANY_DEF_TEXT "Existe mais de uma definio do relatrio solicitado."

#define E004_RUN_ERROR "E004_RUN_ERROR"
#define E004_RUN_ERROR_TEXT "Ocorreu uma falha durante a execuo do relatrio. Veja detalhes no log do servidor."

#define E005_EXTRACT_RPO "E005_EXTRACT_RPO"
#define E005_EXTRACT_RPO_TEXT "No foi possvel extrair definio do relatrio do RPO."

#define E006_IO_ERROR  "E006_IO_ERROR"
#define E006_IO_ERROR_TEXT "Falha durante operao de I/O. "

#define E007_SGDB_NOT_SUPPORTED  "E007_SGDB_NOT_SUPPORTED"
#define E007_SGDB_NOT_SUPPORTED_TEXT "SGDB no suportado pelo servio de impresso (WebViewer)."

#define E008_CATALINA_HOME       "E008_CATALINA_HOME"
#define E008_CATALINA_HOME_TEXT "Varivel de ambiente CATALINA_HOME no foi definida no servidor do Protheus Server."

#define E009_XML_ERROR           "E009_XML_ERROR"
#define E009_XML_ERROR_TEXT      "Erro "

#define E010_DB_NOT_CONNECTED    "E010_DB_NOT_CONNECTED"
#define E010_DB_NOT_CONNECTED_TEXT  "Banco de dados no conectado ou RPO no compatvel."
...
// ##################################################################################
// Meta linguagem para definio do relatrio pr-definido
// ##################################################################################
...
#command columns; // marcao utilizada para reconhecimento de identao e estrutura
=> SX3->(dbSetOrder(2))
...
#command parameters; // marcao utilizada para reconhecimento de identao e estrutura
=>
...
//#command groups;
//=> // marcao utilizada para reconhecimento de identao e estrutura
...
// ##################################################################################
// Meta linguagem para execuo de relatrio pr-definido
// ##################################################################################
