// Layouts               
#DEFINE FF_LAYOUT_VERT_DESCR_TOP 			001 // Vertical com descrio acima do get
#DEFINE FF_LAYOUT_VERT_DESCR_LEFT			002 // Vertical com descrio a esquerda
#DEFINE FF_LAYOUT_HORZ_DESCR_TOP 			003 // Horizontal com descrio acima do get
#DEFINE FF_LAYOUT_HORZ_DESCR_LEFT			004 // Horizontal com descrio a esquerda

// Posicionamentos primrios
#DEFINE FF_COLUMN_WIDTH_DESCR  		040 // Largura da coluna da descrio
...
#Define FF_CTRL_HEIGHT_DESCR_TOP	050 // Altura da linha quando descrio acima 
#Define FF_CTRL_HEIGHT_DESCR_LEFT	022 // Altura da linha quando descrio a esquerda 
#Define FF_DESCR_HEIGHT						018 // Altura da descrio
#Define FF_HEADER_HEIGHT 					011 // Altura do Header no FWEditPanel 
#Define FF_SCROLL_WIDTH						015 // Largura da Scroll lateral
#Define FF_BUTTON_WIDTH						022 // Largura do boto de consulta padro
#Define FF_BUTTON_HEIGHT					011 // Altura do boto de Imagem/Memo (lX3Memo da MSMGet)
#Define FF_CHECK_WIDTH						022 // Largura do quandrado do CheckBox
#Define FF_CHECK_HEIGHT						014 // Altura padro do campo Check
#Define FF_MSGET_HEIGHT						012 // Altura padro do MSGET
#Define FF_COMBO_BUTTON_WIDTH			025 // Largura do boto da ComboBox
#Define FF_COMBO_BUTTON_HEIGHT			015 // Largura do boto da ComboBox
